 ...
 * @since 1.0
 */
public class ActionFormRequestInfo{
    ...
    /**
     * Retorna o identificador das seções selecionadas.
     * 
     * @return Lista contendo os identificadores das seções selecionadas.
     */
    ...
    /**
     * Define os identificadores das seções selecionadas.
     * 
     * @param currentSection Lista contendo os identificadores das seções selecionadas.
     */
    public void setCurrentSections(List<String> currentSections){
